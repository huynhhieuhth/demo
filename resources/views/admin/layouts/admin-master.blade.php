...
<head>
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="{!! url('admin/css/material-dashboard.css?v=3.0.5') !!}" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <script src="{!! url('admin/js/core/js/core/bootstrap.min.js') !!}"></script>
  ...
  <script src="{!! url('admin/js/js/plugins/chartjs.min.js') !!}"></script>
  <script>
  ...
  <script src="{{ url('admin/js/material-dashboard.min.js?v=3.0.5') }}"></script>
